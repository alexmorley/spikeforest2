...
def test_crosscorrelogram():
    ...
    counts1, edges1 = spikeforest.spikewidgets.widgets.crosscorrelogramswidget.compute_autocorrelogram(times, max_dt_tp=20, bin_size_tp=0.1)
    counts2, edges2 = spikeforest.spikewidgets.widgets.crosscorrelogramswidget.compute_crosscorrelogram(times, max_dt_tp=20, bin_size_tp=0.1)

    roughly_equals(counts1, counts2)


def roughly_equals(a, b):
    # TODO: implement
    return True
